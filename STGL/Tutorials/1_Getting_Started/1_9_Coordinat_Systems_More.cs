...
{
    public class _1_9_Coordinat_Systems_more
    {
        ...
        public static void Run() {
            ...
            while (!GLFW.WindowShouldClose(window)) {
                ...
                for (int i = 0; i < cubePositions.Length; i++) {
                    ...
                    matV.Rotate((float)Math.Sin(GLFW.GetTime()) * 20, new Vector3F(0, 1, 0));
                    var matP = GLM.Perspective(45, (float)m_nWidth / m_nHeight, 2f, 20f);
